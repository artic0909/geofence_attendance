...
<div class="page-heading">
  <div class="page-heading-copy">
    ...
    <div>
      ...
      <h1 class="h3 mb-1">New Department</h1>
      <p class="text-muted mb-0">Create a new department for your organization.</p>
    </div>
  </div>
</div>
            ...
            <div class="panel-body p-4">
                <form action="{{ route('admin.departments.store') }}" method="POST" class="validate-form">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" data-rule-required="true" class="form-control" placeholder="e.g. Sales">
                        @error('name')
