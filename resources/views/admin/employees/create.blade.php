...
<div class="page-heading">
  <div class="page-heading-copy">
    ...
    <div>
      ...
      <h1 class="h3 mb-1">New Employee</h1>
      <p class="text-muted mb-0">Add a new staff member and assign them to sites.</p>
    </div>
  </div>
...
<form action="{{ route('admin.employees.store') }}" method="POST" id="employeeForm" class="validate-form mt-4">
    @csrf
        ...
        <div class="panel-body p-4">
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" id="email" data-rule-required="true" data-rule-email="true" autocomplete="off" class="form-control" value="{{ old('email') }}">
                    @error('email')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                </div>

                <div class="col-md-6">
                    <label for="phone" class="form-label fw-bold">Phone Number <span class="text-danger">*</span></label>
                    <input type="text" name="phone" id="phone" data-rule-required="true" class="form-control" value="{{ old('phone') }}">
                    @error('phone')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                </div>

                <div class="col-md-6">
                    <label for="employee_id" class="form-label fw-bold">Employee ID <span class="text-danger">*</span></label>
                    <input type="text" name="employee_id" id="employee_id" data-rule-required="true" class="form-control" value="{{ old('employee_id') }}">
                ...
                <div class="col-md-6">
                    <label for="designation_id" class="form-label fw-bold">Designation <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" name="daily_rate_amount" id="daily_rate_amount" class="form-control" value="{{ old('daily_rate_amount') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" name="ot_rate_amount" id="ot_rate_amount" class="form-control" value="{{ old('ot_rate_amount') }}">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="password" name="password" id="password" data-rule-required="true" autocomplete="new-password" class="form-control border-end-0">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="password" name="password_confirmation" id="password_confirmation" data-rule-required="true" autocomplete="new-password" class="form-control border-end-0">
        ...
        <div class="panel-body p-4">
            ...
            <div class="row g-3" id="geofenceList">
                ...
                <div class="col-md-6 geofence-item">
                    <label class="d-flex align-items-center p-3 border rounded bg-light border-secondary-subtle cursor-pointer h-100">
                        <input class="form-check-input mt-0 me-3 fs-5" type="checkbox" name="geofences[]" value="{{ $geofence->id }}" {{ (is_array(old('geofences')) && in_array($geofence->id, old('geofences'))) ? 'checked' : '' }}>
                        <div>
            ...
            <div class="mt-4 pt-3 border-top">
                <div class="form-check form-switch form-check-lg d-flex align-items-center mb-3">
                    <input class="form-check-input fs-4 mt-0 me-3" type="checkbox" role="switch" name="phone_used_restricted" id="phone_used_restricted" value="1" {{ old('phone_used_restricted') ? 'checked' : '' }}>
    ...
    <div class="d-flex justify-content-end pb-5 gap-2">
        ...
        <button type="submit" class="btn btn-primary btn-lg px-5 shadow"><i class="bi bi-check2-circle me-2"></i> Create Employee</button>
    </div>
</form>
@endsection
