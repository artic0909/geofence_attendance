...
<div class="mb-8">
    ...
    <p class="text-gray-600">Welcome to Site Sync <span class="font-bold text-danger" style="text-transform: capitalize;">{{ auth()->user()->name }}</span> Panel</p>
</div>
        ...
        <div class="searchbar mb-2">
            <form method="GET" id="filterForm" action="{{ route('admin.attendances') }}" class="row">
                ...
                <div class="col-12 mt-3 text-end">
                    ...
                    <button type="submit" formaction="{{ route('admin.attendances.export') }}" class="btn btn-success mx-2">Export to Excel</button>
                    <a href="{{ route('admin.attendances') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
