...
<div class="mb-8">
    ...
    <p class="text-gray-600">Welcome to Palgeo Admin Panel</p>
</div>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $attendance->check_in ? $attendance->check_in->format('H:i') : 'N/A' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $attendance->check_out ? $attendance->check_out->format('H:i') : 'N/A' }}</td>
