...
<div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 max-w-2xl mx-auto mt-8">
    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
        <h3 class="text-lg font-bold text-gray-800">Edit Designation</h3>
    </div>
    ...
    <div class="p-6">
        <form action="{{ route('admin.designations.update', $designation) }}" method="POST">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-navy text-white rounded-lg hover:bg-[#233554] font-medium">Update Designation</button>
            </div>
        </form>
    </div>
</div>
