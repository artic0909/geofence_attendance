...
@section('content')
<div class="flex min-h-[calc(100vh-80px)] bg-gray-50">
    <!-- Left side: Form -->
    <div class="flex-1 flex flex-col py-12 px-4 sm:px-6 lg:flex-none lg:w-1/2 xl:w-3/5">
        <div class="mx-auto w-full max-w-3xl lg:px-8">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-navy">
                <div class="px-6 py-8 sm:px-10 sm:py-10">
                    ...
                    <form id="registerForm" method="POST" action="{{ route('register.submit') }}" class="space-y-8">
                        ...
                        <div class="pt-8 flex justify-end border-t border-gray-200">
                            <button type="submit" class="bg-navy text-white px-8 py-3 rounded-md text-lg font-bold shadow-md hover:bg-blue-800 transition-all duration-200 transform hover:-translate-y-0.5">
                                Submit Registration
                            </button>
                        </div>
                    </form>
    ...
    <div class="hidden lg:block relative w-0 flex-1 lg:w-1/2 xl:w-2/5 bg-navy">
        <div class="absolute inset-0 h-full w-full object-cover">
            <div class="sticky top-[100px] flex flex-col items-center justify-center p-12 h-[calc(100vh-100px)]">
                <!-- Background Overlay -->
...
<script>
    ...
    $(document).ready(function() {
        // Custom rule for exact zipcode logic if needed (numbers only)
        ...
        $("#registerForm").validate({
            ...
            messages: {
                zip_code: {
                    ...
                    numbersOnly: "Zip code must contain numbers only"
                },
                password_confirmation: {
            ...
            errorPlacement: function (error, element) {
                error.addClass('invalid-feedback text-red-500 text-xs mt-1 block');
