...
<body class="bg-gray-100 h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-gray-900 text-white flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="{{ route('superadmin.coupons.index') }}" class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-800 transition {{ request()->routeIs('superadmin.coupons.*') ? 'bg-gray-800 text-white' : 'text-gray-400' }}">
            ...
            <a href="{{ route('superadmin.contacts.index') }}" class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-800 transition {{ request()->routeIs('superadmin.contacts.*') ? 'bg-gray-800 text-white' : 'text-gray-400' }}">
                ...
                @endphp
                @if($unreadContacts > 0)
                    <span class="ml-auto inline-flex items-center justify-center px-2 py-0.5 text-xs font-bold leading-none text-white bg-red-600 rounded-full">{{ $unreadContacts }}</span>
                @endif
            </a>
