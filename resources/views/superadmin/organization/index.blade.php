...
<div class="max-w-7xl mx-auto">
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div class="flex space-x-2 w-full md:w-auto overflow-x-auto pb-2 md:pb-0">
            ...
            <a href="{{ route('superadmin.organizations.index', ['filter' => 'pending', 'search' => request('search')]) }}" class="px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap {{ request('filter') == 'pending' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50' }}">New / Pending</a>
            <a href="{{ route('superadmin.organizations.index', ['filter' => 'active', 'search' => request('search')]) }}" class="px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap {{ request('filter') == 'active' ? 'bg-green-600 text-white' : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50' }}">Active</a>
            <a href="{{ route('superadmin.organizations.index', ['filter' => 'expiring_soon', 'search' => request('search')]) }}" class="px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap {{ request('filter') == 'expiring_soon' ? 'bg-yellow-500 text-white' : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50' }}">Expiring (≤ 3 days)</a>
            <a href="{{ route('superadmin.organizations.index', ['filter' => 'expired', 'search' => request('search')]) }}" class="px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap {{ request('filter') == 'expired' ? 'bg-red-600 text-white' : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50' }}">Expired</a>
        </div>
    </div>
