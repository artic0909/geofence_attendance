...
<form action="{{ route('superadmin.organizations.employees.update', [$org->id, $employee->id]) }}" method="POST" id="employeeForm" class="space-y-8 max-w-5xl validate-form">
    @csrf
    @method('PUT')
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" data-rule-required="true" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-saffron focus:border-saffron outline-none transition-all" value="{{ old('name', $employee->name) }}">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" data-rule-required="true" data-rule-email="true" autocomplete="off" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-saffron focus:border-saffron outline-none transition-all" value="{{ old('email', $employee->email) }}">
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" data-rule-required="true" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-saffron focus:border-saffron outline-none transition-all" value="{{ old('phone', $employee->phone) }}">
                ...
                <div>
                    ...
                    <input type="text" name="employee_id" id="employee_id" data-rule-required="true" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-saffron focus:border-saffron outline-none transition-all" value="{{ old('employee_id', $employee->employee_id) }}">
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="password" id="password" autocomplete="new-password" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-saffron focus:border-saffron outline-none transition-all pr-12">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="password_confirmation" autocomplete="new-password" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:bg-white focus:ring-2 focus:ring-saffron focus:border-saffron outline-none transition-all pr-12">
    ...
    <div class="flex justify-end pt-2 pb-16 space-x-4">
        <a href="{{ route('superadmin.organizations.employees.index', $org->id) }}" class="px-6 py-3 bg-white text-gray-700 border border-gray-300 font-bold rounded-xl shadow-sm hover:bg-gray-50 transition-all duration-300">
            Cancel
        </a>
