...
@section('title', 'Action Required - Expiring Soon')
@section('header', 'Organizations Expiring Soon (≤ 3 Days)')

@section('content')
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Expiring Subscriptions</h2>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Days Left</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($organizations as $org)
                        ...
                        @endphp
                    <tr class="hover:bg-yellow-50 transition bg-yellow-50/30">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-xs text-gray-500">Expires: {{ $org->subscription_expires_at->format('M d, Y') }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-bold {{ $daysLeft == 0 ? 'text-red-600' : 'text-yellow-600' }}">
                                @if($daysLeft > 0)
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                <svg class="w-12 h-12 text-gray-300 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                <span>No organizations have subscriptions expiring soon.</span>
                            </div>
                        </td>
                    </tr>
                    @endforelse
