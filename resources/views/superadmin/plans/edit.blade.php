            ...
            <form action="{{ route('superadmin.plans.update', $plan) }}" method="POST">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="number" name="employee_count" id="employee_count" value="{{ $plan->employee_count ?? 10 }}" required min="1" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-navy focus:border-navy sm:text-sm">
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="is_trial" name="is_trial" type="checkbox" value="1" {{ $plan->is_trial ? 'checked' : '' }} class="focus:ring-navy h-4 w-4 text-navy border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
